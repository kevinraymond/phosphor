            ...
            egui::Frame::new()
                ...
                .show(ui, |ui| {
                    ui.horizontal(|ui| {
                        ...
                        if ui
                            .add_sized(Vec2::new(name_w.max(40.0), MIN_INTERACT_HEIGHT), btn)
                            .on_hover_text(name)
                            .clicked()
                        {
                            ui.ctx().data_mut(|d| {
                        ...
                        .frame(false);
                        if ui
                            .add_sized(Vec2::new(20.0, MIN_INTERACT_HEIGHT), del_btn)
                            .clicked()
                        {
                            if is_armed {
                                ui.ctx().data_mut(|d| {
                ...
                egui::Frame::new()
                    ...
                    .show(ui, |ui| {
                        ...
                        ui.horizontal(|ui| {
                            ...
                            let right_w =
                                48.0 + if cue.transition != TransitionType::Cut {
                                    38.0
                                } else {
                                    0.0
                                } + 16.0
                        ...
                        let is_timer = info
                            .timeline
                            .as_ref()
                            .map_or(false, |t| matches!(t.advance_mode, AdvanceMode::Timer));
                        if is_timer {
                            ui.horizontal(|ui| {
                                ui.add_space(18.0);
                                ui.label(
