...
/// Grid dimensions covering clip-space [-1,1]x[-1,1].
/// 40x40 cells, cell_size = 0.05 in clip space.
const GRID_W: u32 = 40;
const GRID_H: u32 = 40;
const NUM_CELLS: u32 = GRID_W * GRID_H; // 1600
